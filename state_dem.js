window.onload = function () {
	...
	document.getElementById('dateInputYest').value = yestDate.getFullYear() + "-" + makeTwoDigits(yestDate.getMonth() + 1) + "-" + makeTwoDigits(yestDate.getDate());
    initializePlotDiv();
    fetchForecastValues();
...
function fetchForecastValues() {
	...
	var inpYestDate = new Date(document.getElementById('dateInputYest').value+"T00:00:00");
	...
	var yestDate = new Date(document.getElementById('dateInputYest').value+"T00:00:00");
	var tomDate = new Date(todayDate.getTime() + 86400000);
	var yestDateNext = new Date(yestDate.getTime() + 86400000);
    ...
    var yestDateNextStr = makeTwoDigits(yestDateNext.getDate()) + "/" + makeTwoDigits(yestDateNext.getMonth() + 1) + "/" + yestDateNext.getFullYear();
    ...
    for (var i = 0; i < payLoadSources_g.length; i++) {
        ...
        if (payLoadSources_g[i].fetch_period == 'yest') {
            ...
            end_time_str = yestDateNextStr + "/00:00:00";
